...
net.einspunktnull.addon.pv3d
{
	...
	*/
	public class DoublePlane extends TriangleMesh3D
	{
		...
		*/
		public function DoublePlane( materials:MaterialsList, width:Number=500, height:Number=500, segmentsS:int=1, segmentsT:int=1, segmentsH:int=1, insideFaces:int=0, excludeFaces:int=0, initObject:Object=null )
		{
			...
			buildCube( width, height);
		}
	
		private function buildCube( width:Number, height:Number):void
		{
